...
/*   Updated: 2021/05/18 19:23:09 by chanykim         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				pre_exec_env(t_cmd *exec_cmd, pid_t *pid, t_list *exec_env);
...
void				exec_cmd(t_cmd **cmd, t_envlist *env_set, char **envp, char **path);
int					exec(t_cmd **cmd, t_envlist *env_set);
