...
void					exec_not_built_in(t_cmd *exec_cmd,
	char **path, char **envp);
int						pre_exec_cd(t_cmd *exec_cmd,
	pid_t *pid);
int						pre_exec_env(t_cmd *exec_cmd,
	pid_t *pid, t_env *env_set);
int						pre_exec_export(t_cmd *exec_cmd,
	pid_t *pid, t_env *env_info);
int						pre_exec_unset(t_cmd *exec_cmd,
	pid_t *pid, t_env *env_info);
...
int						check_in_quote(char *buf, int start,
	int single_q, int double_q);
