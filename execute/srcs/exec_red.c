...
// /*   Updated: 2021/06/10 21:27:21 by hyopark          ###   ########.fr       */
// /*                                                                            */
// /* ************************************************************************** */
...
// int		exec_redirection(t_red **tmp)
// {
// 	if ((*tmp)->type == IN)
// 	{
...
// 	if (exec_cmd == NULL || exec_cmd->cmd[0] == NULL
// 		|| ft_strlen(exec_cmd->cmd[0]) < 1)
// 		return ;
